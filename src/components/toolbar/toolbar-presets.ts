...
export const TOOLBAR_TRANSLATIONS = {
  zh: {
    ...
    previewOnly: '预览',
    autoFitBtn: '单页适配',
    autoFitSuccess: '已适配单页',
    autoFitTooltip: '自动微调页边距与间距，尽量适配为单页',
    aestheticsLabel: '排版',
  ...
  en: {
    ...
    previewOnly: 'Preview',
    autoFitBtn: 'Fit Page',
    autoFitSuccess: 'Fitted to one page',
    autoFitTooltip: 'Adjust margins and spacing to fit one page when possible',
