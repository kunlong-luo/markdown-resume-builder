    ...
    <header className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800/90 relative z-50 shadow-[0_1px_3px_rgba(15,23,42,0.03)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.4)] transition-colors duration-200">
      ...
      <div className="flex md:hidden items-center justify-between px-3.5 h-12 w-full">
        <div className="flex items-center gap-2 shrink-0">
          <div className="p-1.5 bg-gradient-to-tr from-indigo-600 via-indigo-600 to-blue-600 rounded-lg text-white flex items-center justify-center">
      ...
      <div className="hidden md:flex items-center justify-between px-6 py-2 w-full">
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            ...
            <div>
              <h1 className="text-base font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 bg-indigo-50 dark:bg-indigo-950/80 text-indigo-600 dark:text-indigo-300 text-[10px] rounded-full font-bold border border-indigo-200/80 dark:border-indigo-800 shadow-2xs whitespace-nowrap">
                  PRO
                </span>
              </h1>
            </div>
        ...
        <div className="flex items-center gap-2 justify-end shrink-0">
          ...
          <Tooltip content={isEn ? 'User Guide & Privacy Policy' : '求职指南与隐私说明'} side="bottom">
            <button
          ...
          {isInstallable && (
            <Tooltip content={isEn ? 'Install as Desktop / Mobile App' : '安装为桌面或手机独立应用'} side="bottom">
              ...
              >
                <DownloadCloud className="w-3.5 h-3.5 text-emerald-500 shrink-0 animate-bounce" />
          ...
          {/* Diagnostic Button */}
          <Tooltip content={isEn ? 'ATS Diagnostic & Optimization' : 'ATS 自检与关键词诊断'} side="bottom">
            <button
            ...
            >
              ...
              <span>{isEn ? 'ATS Check' : '简历自检'}</span>
            </button>
          </Tooltip>

          {/* Versions Button */}
          <Tooltip content={isEn ? 'Job Versions & History Backups' : '岗位版本库与历史草稿'} side="bottom">
            <button
          ...
          <Tooltip content={isEn ? 'Download high-definition A4 PDF' : '下载高清 A4 PDF 简历'} side="bottom">
            <button
              onClick={() => handleTriggerExport()}
              disabled={isExportingPDF}
          ...
          <div className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 rounded-t-2xl p-4 flex flex-col gap-3 shadow-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <span>{isEn ? 'Export MD' : '导出 MD 源码'}</span>
              </button>
