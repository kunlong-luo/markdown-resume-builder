...
export function SectionPresets({ onAddPreset, lang = 'zh' }: SectionPresetsProps) {
  ...
  return (
    <div className="pt-6 border-t border-slate-200 dark:border-slate-800">
      <label className="block text-[11px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-4 text-center">
        {isEn ? 'Add New Section / Resume Block' : '添加新版块 / 简历模块'}
      </label>
      
      {/* 常用标准模板 */}
      <div className="mb-4">
        <span className="text-[10px] font-bold text-slate-400 dark:text-slate-400 block mb-2">
