...
export const zh: TranslationSchema = {
  ...
  toolbar: {
    ...
    sectionSorter: '板块排序',
    autoFit: '一键压缩贴合',
    autoFitTooltip: '自动微调间距与边距，将当前溢出的内容收纳于 1 页内',
    typesettingSpace: '中英排版',
    typesettingSpaceTooltip: '自动在中文与英文、数字之间插入美学空格',
  ...
  importer: {
    title: '智能杂乱纯文本一键导入',
    description: '复制各大招聘网站、旧 Word 简历或 PDF 乱序文本，算法将自动清洗重组为规范 Markdown。',
    placeholder: '在此粘贴您的旧简历或杂乱文本...\n例如：张三 手机 13800138000 邮箱 zhangsan@example.com 5年前端经验...',
    importBtn: '开始智能提取解析',
    privacyNotice: '所有解析均在浏览器本地纯前端完成，隐私安全零泄露。',
  },
  errorBoundary: {
    title: '遇到未预期的运行时异常',
